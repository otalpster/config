" Vim Color File
" Name:       otalpster.vim
" Maintainer: https://github.com/otalpster
...
call s:h("CursorLineNr", { "fg": s:true_white, "bg": s:true_black, "gui": "bold" })
